      ...
      My Vendors
          ...
          <View className="flex-row items-center justify-between mb-2">
            ...
            <View className="flex-row items-center space-x-2">
              ...
              <Pressable
                className={`items-center p-1.5 rounded-lg ${isSortModalVisible || selectedSort ? 'border-2 border-green-500 bg-green-50' : ''}`}
                onPress={() => {
...
{isFilterModalVisible && !isSortModalVisible && (
  <View style={{ position: 'absolute', top: 120, left: 0, right: 0, bottom: 0, backgroundColor: 'white', borderTopLeftRadius: 20, borderTopRightRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 10, zIndex: 10 }}>
