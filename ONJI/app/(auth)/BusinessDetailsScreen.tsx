    ...
    <View className="bg-surface-page flex-1">
      <View className="mx-7 flex-1 " style={{ paddingBottom: insets.bottom }}>
        ...
        <View className="flex-1">
          <View className="flex-row justify-between mt-6" style={{ height: height * 0.04 }}>
            <RadioInput handleMethod={handlePress} label={'Supplier'} radioState={radioState} />
            <RadioInput handleMethod={handlePress} label={'Retailer'} radioState={radioState} />
          </View>
          ...
          >
            {({ values, handleChange, handleBlur, handleSubmit, touched, isValid, errors }) => (
              <View className="flex-1 justify-between">
                <View className="mt-6">
                  ...
                  {errors.pinCode && touched.pinCode && (
                    <View>
                      <Text className="text-text-error">{errors.pinCode}</Text>
                    </View>
                  )}
                </View>
                <View>
